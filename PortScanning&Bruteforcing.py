...
class PortScannerApp:
    ...
    def create_port_scanning_section(self):
        ...
        self.scan_ports_button = ttk.Button(port_scan_subframe, text="Scan Ports", command=self.start_scan_ports,
                                            style="Bold.TButton")
        ...
        self.stop_scan_button = ttk.Button(port_scan_subframe, text="Stop", command=self.stop_scan_ports,
                                           style="Bold.TButton")
        ...
        ttk.Label(self.port_scan_output_frame, text="Port Scan Output", style="Bold.TLabel").grid(row=0, column=0,
                                                                                                  sticky="w", pady=5)
    ...
    def create_gobuster_section(self):
        ...
        self.gobuster_scan_button = ttk.Button(gobuster_subframe, text="Run Gobuster", command=self.run_gobuster,
                                               style="Bold.TButton")
        ...
        ttk.Label(self.gobuster_output_frame, text="Gobuster Output", style="Bold.TLabel").grid(row=0, column=0,
                                                                                               sticky="w", pady=5)
